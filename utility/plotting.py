...
def plot_multi(data, idx, shots=None, colors=['black', 'red', 'blue']):
    ...
    Args:
        ...
        shots (list, optional): List of shot counts for each solver.
        colors (list, optional): List of colors for each solver.
   ...
   #        field[:, -1] = d['field']['u'][:, -1]
    ...
    for i, t in enumerate(idx):
        ...
        for j, field in enumerate(data_fields):
            style = 'lineplot' if j == 0 else 'lineplot'
            #style = 'lineplot'
